...
export const updateWikiPage=(repoId,slug,data)=>apiClient.post(`/repositories/${repoId}/wiki/${slug}`,data)
export const deleteWikiPage=(repoId,slug)=>apiClient.delete(`/repositories/${repoId}/wiki/`)
